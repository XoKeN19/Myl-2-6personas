...
export function rollInitiative(
  ...
  return {
    ...
    startedAt: now,
    // Cada lanzamiento tiene tiempo para recorrer la mesa, rodar y mostrar el
    // resultado. No reiniciamos la animación a mitad de un giro.
    endsAt: now + rounds.length * 4400 + 3200,
    rounds,
    winner: contenders[0],
  };
}
